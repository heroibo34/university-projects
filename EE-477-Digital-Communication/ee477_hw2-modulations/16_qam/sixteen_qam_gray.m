...
save sixteenQAM_gray_demo.mat sim_res
%% yukledikten sonra
energy_norm_coeff=1;
Infty=50;
number_of_bits=3000;
...
semilogy(10*log10(SNR), bit_error_rate, 'c-x','DisplayName','BER-Eb gray(16QAM)');
hold on;
semilogy(10*log10(SNR), symbol_error_theory*1/4, 'cs','DisplayName','BER-Eb theory gray(16QAM)');
hold on;
grid on;
