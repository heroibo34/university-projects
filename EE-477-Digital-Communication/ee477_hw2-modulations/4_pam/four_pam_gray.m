...
code_symbols=energy_norm_coeff*[-3,-1,3,1]*exp(1j*2*pi);
...
save fourPAM_bit1_gray.mat sim_res
...
semilogy(snr_db, bit_error_rate, 'g-x','DisplayName','BER-Eb gray(4PAM)');
hold on;

%symbol error rate with q function for Es
semilogy(snr_db, symbol_error_theory*1/2, 'gs','DisplayName','BER-Eb theory gray(4PAM)');
hold on;
