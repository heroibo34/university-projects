...
hold on;
semilogy(10*log10(SNR), bit_error_rate, 'm-x','DisplayName','BER-Eb(BFSK)');
hold on;
semilogy(10*log10(SNR), symbol_error_theory, 'ms','DisplayName','BER-Eb theory(BFSK)');
hold on;
grid on;
xlabel('SNR')
ylabel('ERROR')
