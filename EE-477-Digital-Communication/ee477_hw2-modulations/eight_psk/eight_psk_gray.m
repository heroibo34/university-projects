...
code_symbols=energy_norm_coeff*exp(1j*2*pi*(y+1)/M);
...
save eightPSK_gray_bit.mat sim_res
...
hold on;
semilogy(10*log10(SNR), bit_error_rate, 'b-x','DisplayName','BER-Eb gray(8PSK)');
hold on;
semilogy(10*log10(SNR), symbol_error_theory*5/12, 'bs','DisplayName','BER-Eb theory gray(8PSK)'); %1/3 olmali aslinda
hold on;
grid on;
